...
export function GET({ props }) {
  ...
  return new Response(JSON.stringify({
    ...snapshot,
    current_record_url: `${base}data/signals/${snapshot.record_id}.json`,
    collection_url: `${base}data/intelligence.json`,
    schema_url: `${base}schema/record-version.schema.json`,
    version_permalink: `${base}data/signals/${snapshot.record_id}/versions/${snapshot.record_version}.json`,
